...
struct TBoundingBox
{
    ...
    // \brief Slice the bounding box into octants
    void octSlice(int octIndex)
    {
        bool x = octIndex & 1;
        bool y = octIndex & 2;
        bool z = octIndex & 4;
        ...
        min.x() = x ? center.x() : min.x();
        max.x() = x ? max.x() : center.x();
        min.y() = y ? center.y() : min.y();
        max.y() = y ? max.y() : center.y();
        min.z() = z ? center.z() : min.z();
        max.z() = z ? max.z() : center.z();
    }

    void getOctant(int octIndex, BoundingBox3f &outOctant) const
    {
        bool x = octIndex & 1;
        bool y = octIndex & 2;
        bool z = octIndex & 4;
        ...
        outOctant.min.x() = x ? center.x() : min.x();
        outOctant.max.x() = x ? max.x() : center.x();
        outOctant.min.y() = y ? center.y() : min.y();
        outOctant.max.y() = y ? max.y() : center.y();
        outOctant.min.z() = z ? center.z() : min.z();
        outOctant.max.z() = z ? max.z() : center.z();
    }
