...
public:
    ...
    void initializeGUI()
    {
        ...
        m_pointCountSlider->set_callback([&](float)
                                         { refresh(); });
        ...
        m_pointTypeBox->set_callback([&](int)
                                     { refresh(); });
        ...
        m_parameterSlider->set_callback([&](float)
                                        { refresh(); });
        ...
        m_parameter2Slider->set_callback([&](float)
                                         { refresh(); });
        ...
        m_gridCheckBox->set_callback([&](bool)
                                     { refresh(); });
        ...
        m_angleSlider->set_callback([&](float)
                                    { refresh(); });
        ...
        m_brdfValueCheckBox->set_callback([&](bool)
                                          { refresh(); });
